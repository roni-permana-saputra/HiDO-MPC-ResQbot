...
from BMPC_resqbot_class import MPC_single_shooting_multi_objective as MPC
...
def main(V0, C0, T, N):
    ...
    while((err_thresh > .025 or dist2line >  .025 or angle_diff > .025) and mpciter < 500):
        # Begin the MPC stopwatch
        tic = time.time()

        # Choose the MPC formulation
        # Formulate the MPC
        mpc = MPC(T, N, v_max, v_min, w_max, w_min, const_line)
